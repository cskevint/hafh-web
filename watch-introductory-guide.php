...
<body>
    ...
    <section class="container-fluid bg-light">
        <div class="container p-4 p-md-4 p-lg-5">
            ...
            <h3 class="py-2 text-muted text-center">and how you can get started with your own business in just 9 days!</h3>
            <h3 class="py-2 text-center text-primary">Work from home, cuddle dogs, and make money!</h3>
